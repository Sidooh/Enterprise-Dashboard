...
.tooltip-box:after {
    ...
    border-width: 5px;
    border-style: solid;
    border-color: rgba(var(--bs-dark-rgb), .9) transparent transparent transparent;
}

.tooltip-box.bottom:after {
    border-color: transparent transparent rgba(var(--bs-dark-rgb), .9) transparent;
    bottom: 100%;
    left: calc(50% - 5px);
}

.tooltip-box.left:after {
    border-color: transparent transparent transparent rgba(var(--bs-dark-rgb), .9);
    left: 100%;
    top: calc(50% - 5px);
}

.tooltip-box.right:after {
    border-color: transparent rgba(var(--bs-dark-rgb), .9) transparent transparent;
    right: 100%;
    top: calc(50% - 5px);
}
